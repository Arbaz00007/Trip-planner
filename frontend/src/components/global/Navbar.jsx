            ...
            <nav id='navBar' >
                ...
                <div className="links links_container">
                    <ul>
                        ...
                        {
                            currentUser ?
                                <div onClick={() => setIsLogoutDiv(!isLogoutDiv)} className='transition-transform userName text-white flex justify-center items-center gap-[0.1rem] font-extrabold bg-primary'>
                                    <span className='uppercase text-xl'>{(currentUser?.name.charAt(0))}</span>
                                    <AiOutlineDown />
